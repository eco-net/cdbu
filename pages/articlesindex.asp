...
<%
DIM rCount, i, rs
set rs=openRS("Select count(*) as c from cen_data where context=25 and hidden=0 and siteid="&siteid)
rCount=rs("c")
set rs = openRS("Select d.id,t1.content as name, t2.content as text, m.filepath as img from "&_
	...
	"where d.context=25 and d.hidden=0 and d.siteid="&siteid&" order by d.sortnumber")
%>
...
<img src="/media/cykelliv.jpg" border="0" />
<!--/designit-->
...
for i=0 to rCount-1
	...
	response.write "<td width=""50""><a href=""articlelist.asp?catid="&rs("id")&"""><img src="""&rs("img")&""" border=""1""/></a></td>"&_
		"<td width=""250"" valign=""top""><span class=""blue""><a href=""articlelist.asp?catid="&rs("id")&""">"&rs("name")&"</a></span><br>"&rs("text")&"</td>"&vbcrlf
