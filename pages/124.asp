...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Skjulte Sider BU i Danmark"%></title><!--#include virtual="/includes/head.asp" -->
...
<!-- MAIN CONTENT -->
<div id="maincontent">
<h2>Skjulte Sider BU i Danmark</h2>
<div id="maincontenttext">Her lægges skjulte sider om BU i Danmark</div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->
