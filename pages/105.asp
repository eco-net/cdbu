...
<head>
<!--#include virtual="/includes/titleprefix.asp" --><title><%=titleprefix&"Hoved forpligtigelser, initiativer og tidsplaner"%></title><!--#include virtual="/includes/head.asp" -->
...
<!-- MAIN CONTENT -->
<div id="maincontent">
<h2>Hoved forpligtigelser, initiativer og tidsplaner</h2>
<div id="maincontenttext"><P>Der blev på topmødet etableret enighed om en række forpligtigelser, initiativer, målsætninger og tidsplaner. Disse er nedskrevet i papiret ”Key Outcomed of the Summit”. </P>
<P>I det følgende kan du finde de vigtigste af disse under følgende overskrifter:</P>
<P>&nbsp;Fattigdom og ulighed. </P>
<P>Vand. </P>
<P>Energi. </P>
<P>Sundhed. </P>
<P>Ernæring og landbrug. </P>
<P>Biodiversitet. </P>
<P>Tværgående. </P>
<P>Bæredygtig produktion og forbrug. </P>
<P>Kemikalier.</P></div><!-- maincontenttext -->
</div><!-- maincontent -->
<!-- END MAIN CONTENT -->
