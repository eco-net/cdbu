...
FUNCTION GetSetting(datatype,siteid,lang)
	DIM rs
	set rs=server.createobject("ADODB.recordset")
	rs.activeconnection=gConn
	rs.source="SELECT settingsvalue,settingstext FROM cen_settings WHERE siteid="&siteid&" and datatype=" & datatype
...
FUNCTION getNamedOptionsFromDb(theTable, criteria, nameField, valueField, selectField, selectValue, sortField,extraInfo, firstlabel)
	...
	Dim rs_XX, whereClause, resultString, strValue, strSelect, sortString, arrExtraInfo
